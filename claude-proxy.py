                ...
                if isinstance(message.get("content"), list):
                    for item in message["content"]:
                        if item["type"] == "text":
                            ...
                            if image_count >= 64:
                                raise ValueError("Maximum of 64 images per API call exceeded")
                            ...
                            if total_image_size > 500 * 1024 * 1024:
                                raise ValueError("Total size of images exceeds 300 MB limit")
